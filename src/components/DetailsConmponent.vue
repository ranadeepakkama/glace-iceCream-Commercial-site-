<template>
    <div class="bg-cover bg-center w-[160vw] md:max-w-[98vw] h-screen md:m-5 m-3 rounded-5 flex flex-col justify-center items-center" style="font-weight: bold; color: #fff; background-image: url('https://imagedelivery.net/xaKlCos5cTg_1RWzIu_h-A/251f2ed9-c15d-48b4-687b-afdc74af2b00/public');">
        ...
        <div class="flex w-[140vw] md:max-w-[70vw] bg-gray-500/30 rounded-3 justify-between items-center p-3">
            <div class="text-center">
                <h1 style="font-size: 320%;">50+</h1>
                <p class="max-w-[10vw]">Unique Flavors Available</p>
            </div>
            <div class="text-center ">
                <h1 style="font-size: 320%;">1000+</h1>
                <p class="max-w-[10vw]">Happy Customers Served</p>
            </div>
            <div class="text-center">
                <h1 style="font-size: 320%;">150+</h1>
                <p class="max-w-[14vw]">Flavor Combinations Crafted</p>
            </div>
            <div class="text-center">
                <h1 class="pb-3" style="font-size: 320%;">20</h1>
                <p class="max-w-[10vw]">Awards Received</p>
            </div>
        </div>
    </div>
</template>
